...
from errors_with_underlined_arrows import *
...
class Error:
  ...
  def as_string(self):
    ...
    result += '\n\n' + error_with_underlined_arrows(self.pos_start.ftxt, self.pos_start, self.pos_end)
    return result
  ...
  def visit_VarAccessNode(self, node, context):
    ...
    if not value:
      return res.failure(RTError(
        ...
        f"Arreh vai agey '{var_name}' ke define toh kore ne",
        context
      ))
